...
import static arabulkazan.albatros.com.arabulkazan.Fragments.SizeOzel.bilgi_childListMap;
import static arabulkazan.albatros.com.arabulkazan.Fragments.SizeOzel.bilgi_groupList;


public class Exp_Bilgi_List_Adapter implements ExpandableListAdapter {
    Context context;


    public Exp_Bilgi_List_Adapter(Context context) {
    ...
    public int getGroupCount() {
        return bilgi_groupList.size();
    }

    @Override
    public int getChildrenCount(int groupIndex) {
        String group = bilgi_groupList.get(groupIndex);
        List<String> childInfoList = bilgi_childListMap.get(group);
        return childInfoList.size();
    }

    @Override
    public Object getGroup(int groupIndex) {
        return bilgi_groupList.get(groupIndex);
    }
    ...
    public View getGroupView(int groupIndex, boolean isExpanded, View view, ViewGroup viewGroup) {
        ...
        String groupText = bilgi_groupList.get(groupIndex);
