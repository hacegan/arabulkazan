...
import static arabulkazan.albatros.com.arabulkazan.Fragments.SizeOzel.satis_childListMap;
import static arabulkazan.albatros.com.arabulkazan.Fragments.SizeOzel.satis_groupList;


public class Exp_Satis_List_Adapter implements ExpandableListAdapter {
    Context context;


    public Exp_Satis_List_Adapter(Context context) {
    ...
    public int getGroupCount() {
        return satis_groupList.size();
    }

    @Override
    public int getChildrenCount(int groupIndex) {
        String group = satis_groupList.get(groupIndex);
        List<String> childInfoList = satis_childListMap.get(group);
        return childInfoList.size();
    }

    @Override
    public Object getGroup(int groupIndex) {
        return satis_groupList.get(groupIndex);
    }
    ...
    public View getGroupView(int groupIndex, boolean isExpanded, View view, ViewGroup viewGroup) {
        ...
        String groupText = satis_groupList.get(groupIndex);
